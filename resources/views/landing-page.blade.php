...
<body class="font-open-sans">
    <!-- Navbar -->
    <nav class="fixed inset-x-0 top-0 z-[1000] bg-transparent" :class="scrolled ? 'bg-white ' : 'bg-transparent'"
        x-data="{ scrolled: false, mobileNav: false }" x-on:scroll.window="pageYOffset >= 100 ? scrolled = true : scrolled = false">
        <div class="mx-auto max-w-6xl px-6">
            <div class="container mx-auto">
                <div class="mx-1 flex items-center justify-between">
                    <div class="font-poppins text-xl" :class="scrolled ? 'text-sky-950' : 'text-white'">
                        <img src="{{ asset('images/logo/logo-white.svg') }}" alt="" class="w-20"
                            :class="scrolled ? 'hidden' : null" />
                        <img src="{{ asset('images/logo/logo.svg') }}" alt="" class="w-20"
                            :class="!scrolled ? 'hidden' : null" />
                    </div>
                    <div class="text-md hidden items-center gap-x-12 lg:flex"
                        ...
                        <div>
                            <a href="/" class="flex items-center gap-x-2 p-2 transition hover:text-sky-500">
                    ...
                    <div class="lg:hidden">
                        <i class="fa-solid fa-bars cursor-pointer text-2xl transition hover:text-sky-500"
                            :class="scrolled ? 'text-sky-950' : 'text-white'" x-on:click="mobileNav = !mobileNav"
                            x-show="!mobileNav" x-transition:enter="transition" x-transition:enter-start="opacity-0"
                    ...
                    <div class="fixed inset-0 top-[3.25rem] z-[999] max-w-xs bg-white lg:hidden" x-show="mobileNav"
                        x-on:click.outside="mobileNav = false" x-transition:enter="transition"
                        x-transition:enter-start="opacity-0 -translate-x-full" x-transition:enter-end="opacity-100"
                        x-transition:leave="transition" x-transition:leave-start="opacity-100"
    ...
    <!-- Header -->
    <header class="bg-cover bg-top bg-no-repeat" style="background-image: url('{{ asset('images/hotel-1.jpg') }}')">
    ...
    <section class="mx-auto max-w-6xl px-6 py-12">
        <div class="container mx-auto text-center">
            <div class="text-center">
                <span
                    class="font-open-sans text-sky-950 relative overflow-hidden text-center text-2xl font-bold md:text-3xl">
                    Why Choose Us
                    <span
            ...
            <div class="mt-8">
                <div class="grid grid-cols-2 items-center gap-x-4">
                    <div class="h-80">
                        <img src="{{ asset('/images/hotel-2.jpg') }}" alt=""
                            class="h-full w-full rounded-lg object-cover" />
                    </div>
                    <div class="flex h-80 flex-col gap-y-4">
                        <div class="">
                            <img src="{{ asset('/images/hotel-3.jpg') }}" alt=""
                                class="h-[9.5rem] w-full rounded-lg object-cover" />
                        </div>
                        <div>
                            <img src="{{ asset('/images/hotel-4.jpg') }}" alt=""
                                class="h-[9.5rem] w-full rounded-lg object-cover" />
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto">
            ...
            <div class="mt-8 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <a href="/"
                    ...
                    <div>
                        <img src="../../assets/hotel-rooms/1.jpg" alt="" class="" />
                    </div>
                    <div class="px-4 py-3">
                ...
                <a href="/"
                    class="mx-auto max-w-xs overflow-hidden rounded-lg border border-black/30 shadow-md transition hover:shadow-xl md:max-w-none">
                    <div>
                        <img src="../../assets/hotel-rooms/2.jpg" alt="" class="" />
                    </div>
                    <div class="px-4 py-3">
                        <div class="flex items-center justify-between">
                ...
                <a href="/"
                    class="mx-auto max-w-xs overflow-hidden rounded-lg border border-black/30 shadow-md transition hover:shadow-xl md:max-w-none">
                    <div>
                        <img src="../../assets/hotel-rooms/3.jpg" alt="" class="" />
                    </div>
                    <div class="px-4 py-3">
                        <div class="flex items-center justify-between">
    ...
    <section class="mx-auto max-w-6xl px-6 py-12">
        <div class="container mx-auto">
            ...
            <div class="mt-8 items-center gap-x-12 md:grid md:grid-cols-2" x-data="{ show: 1 }">
                <div class="shrink-0">
                    <img src="{{ asset('/images/hotel-5.jpg') }}" alt=""
                        class="mx-auto aspect-square h-80 w-full rounded-xl object-cover" />
                </div>
                <div class="relative mx-auto mt-4 max-w-lg md:mt-0">
                    <div class="" x-show="show === 1" x-transition:enter="transition"
                        x-transition:enter-start="opacity-0 -translate-y-20" x-transition:enter-end="opacity-100">
                        <div class="">
                    ...
                    <div class="" x-show="show === 2" x-transition:enter="transition"
                        x-transition:enter-start="opacity-0 -translate-y-20" x-transition:enter-end="opacity-100">
                        <div class="">
                            <p class="font-poppins text-sky-950 text-xl font-bold">
                                Ahita Bisma
                    ...
                    <div class="" x-show="show === 3" x-transition:enter="transition"
                        x-transition:enter-start="opacity-0 -translate-y-20" x-transition:enter-end="opacity-100">
                        <div class="">
                            <p class="font-poppins text-sky-950 text-xl font-bold">
                                Usriyatul Khamimah
                    ...
                    <div class="" x-show="show === 4" x-transition:enter="transition"
                        x-transition:enter-start="opacity-0 -translate-y-20" x-transition:enter-end="opacity-100">
                        <div class="">
                            <p class="font-poppins text-sky-950 text-xl font-bold">
                                Michael Andy
                    ...
                    <div class="" x-show="show === 5" x-transition:enter="transition"
                        x-transition:enter-start="opacity-0 -translate-y-20" x-transition:enter-end="opacity-100">
                        <div class="">
                            <p class="font-poppins text-sky-950 text-xl font-bold">
                                Diana Craig
                ...
                <div class="grid grid-cols-1 gap-y-4 text-center text-white sm:grid-cols-2 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center justify-center gap-x-4 text-2xl">
                            <div>
                                <a href="/" class="inline-block transition hover:scale-110">
