            ...
            <div x-data="reservation()">
                <div class="text-center" x-data="{ price_per_day: {{ $roomType->price_per_day }} }">
                    ...
                    <div class="relative mt-2 flex items-center justify-center gap-x-16">
                        <div
                            class="flex h-12 w-12 rounded-full border border-sky-500 bg-sky-500 text-lg font-bold text-white">
                    ...
                    <div class="mt-6 items-stretch overflow-hidden rounded-lg border border-black/20 sm:flex"
                        x-show="show === 1" x-transition:enter="transition" x-transition:enter-start="opacity-0"
                        x-transition:enter-end="opacity-100">
                        <div class="shrink-0 bg-red-200">
                            <img src="../../assets/hotel-rooms/1.jpg" alt=""
                        ...
                        <div class="mt-4 grid grow grid-cols-1 gap-y-1 px-4 text-start text-[12px] sm:mt-0 sm:p-2">
                            ...
                            <p class="mt-2 text-red-500" x-show="firstSlide">
                            ...
                            <div class="grid grid-cols-1 gap-y-1 sm:grid-cols-3 sm:items-center">
                                ...
                                <input type="text" name="room_code" id="room_code" placeholder="Room Code"
                                    value="D101" readonly
                                    class="col-span-2 w-full rounded-md border border-black/60 bg-gray-100 px-3 py-1 focus:outline-blue-500" />
                            </div>
                            <div class="grid grid-cols-1 gap-y-1 sm:grid-cols-3 sm:items-center">
                                ...
                                <input type="text" name="price_per_day" id="price_per_day"
                                    placeholder="Price per Day" :value="price_per_day" x-model="price_per_day" readonly
                                    class="col-span-2 w-full rounded-md border border-black/60 bg-gray-100 px-3 py-1 focus:outline-blue-500" />
                            </div>
                            <div class="grid grid-cols-1 gap-y-1 sm:grid-cols-3 sm:items-center">
                    ...
                    <div class="mt-6 overflow-hidden rounded-lg border border-black/20 p-4 text-start text-[12px]"
                        x-show="show === 2" x-transition:enter="transition" x-transition:enter-start="opacity-0"
                        x-transition:enter-end="opacity-100">
                        <h1 class="font-poppins text-xl">Personal Information</h1>
                        <p class="mt-2 text-red-500" x-show="secondSlide">
                            Please fill the information below!
                        </p>
                        <div class="mt-2 grid grid-cols-1 gap-y-1 sm:grid-cols-3 sm:items-center">
                        ...
                        <div class="mt-2 grid grid-cols-1 gap-y-1 sm:grid-cols-3 sm:items-center">
                            ...
                            <input type="email" name="email" id="email" placeholder="Email"
                                value="maulana.tempariyawan@mhs.unsoed.ac.id" readonly
                                class="col-span-2 w-full rounded-md border border-black/60 bg-gray-100 px-3 py-1 focus:outline-blue-500" />
                        </div>
                        <div class="mt-2 grid grid-cols-1 gap-y-1 sm:grid-cols-3 sm:items-center">
                            <p class="relative font-semibold text-black/60">
                            ...
                            <select name="payment_mtd" id="" x-model="form.payment_mtd"
                        ...
                        <div class="mt-6 overflow-hidden rounded-lg border border-black/20 p-4 text-start text-[12px]">
                            ...
                            <form action="" method="post" class="grid grid-cols-1 gap-y-2">
                                ...
                                <div class="grid grid-cols-1 gap-y-1 sm:grid-cols-3 sm:items-center">
                                    ...
                                    <input type="date" name="date_in" id="date_in" placeholder="Date In"
                                        x-model="form.date_in" readonly
                                        class="col-span-2 w-full rounded-md border border-black/60 bg-gray-100 px-3 py-1 focus:outline-blue-500" />
                                </div>
                                <div class="grid grid-cols-1 gap-y-1 sm:grid-cols-3 sm:items-center">
                                    <p class="font-semibold text-black/60">Date Out</p>
                                    <input type="date" name="date_out" id="date_out" placeholder="Date Out"
                                        x-model="form.date_out" readonly
                                        class="col-span-2 w-full rounded-md border border-black/60 bg-gray-100 px-3 py-1 focus:outline-blue-500" />
                                </div>
                                <div class="grid w-full grid-cols-1 gap-y-1 sm:grid-cols-3 sm:items-center">
                                ...
                                <div class="text-end">
                                    <button type="submit"
                                        class="rounded-lg bg-sky-500 px-3 py-2 text-white transition hover:bg-sky-950">
                                        Make a Reservation
                                    </button>
                                </div>
                            </form>
                    ...
                    <div class="flex justify-center gap-x-6">
                        <span
                            class="mt-2 inline-block cursor-pointer rounded-lg bg-gray-500 px-4 py-2 text-sm text-white transition hover:bg-gray-950"
                            x-on:click="() => {show === 2 ? goPrev1() : goPrev2()}" x-show="show === 2 || show === 3">
                            Prev
                        </span>
                        <span
                            class="mt-2 inline-block cursor-pointer rounded-lg bg-sky-500 px-4 py-2 text-sm text-white transition hover:bg-sky-950"
                            x-on:click="() => {show === 1 ? goNext2() : goNext3()}" x-show="show === 1 || show === 2">
                            Next
                        </span>
                    </div>
                </div>
